"""_tiebreak1 — _facing_v2 + a deterministic, trail-aware tie-break (one change).

Exact-diagonal ties in cardinal_toward were resolved by random.random().
They now resolve toward the tile the builder came from when that is one of
the two tied cardinals. _facing_v2 baseline follows.

_facing_v2 — aug7 + trail linking outside the near-Core zone,
