...
# ============================================================================
# LOKI-9 (v125) -- GARRISON LESS. Our defence is not our problem; it is where
# the titanium went.
#
# MEASURED, on 6.6M rounds of third-party games plus our own:
#   collar occupancy    OURS 66.5%   top tier (>=1900) 40.6%   field 53.2%
#   damage to kill a core   OURS 1,596        top tier 1,019
# We are 400-500 Elo BELOW them and our core is ~57% more expensive to kill.
# They are not starved of bodies (5.59 alive/round against our 5.96) -- they
# hold 0.121 collar-seats per bot against our 0.206. THEY CHOOSE NOT TO
# GARRISON, and they spend the difference on killing.
#
# And the weapon mix is an INVERSION, not a difference of degree:
#   what kills a >=1700 core:  gunner 53.1%  sentinel 44.4%  melee 2.5%
#   what kills OURS:           gunner 22.7%  sentinel 69.2%  melee 8.1%
# (Melee at 2.5% is also the after-the-fact explanation for LOKI-5: silencing
# it cost nothing because it was never doing anything up there.)
#
# THE DEFECT THIS TARGETS. The universal adjacent heal fires whenever
# SLOT_UNDER is set -- and SLOT_UNDER latches for FIFTY ROUNDS off any enemy
# turret within dsq 64, any enemy builder within dsq 16, or ANY HP loss at all.
# So a single point of chip damage buys 50 rounds of every nearby builder
# stopping to heal, at 1 Ti and one MOVE each (acting and moving are mutually
# exclusive). That is the 66.5% occupancy, and it is bought with the rounds and
# titanium the incidence cut says we need for ARRIVING.
#
# LOKI-9 gates the garrison heal on the core being MEANINGFULLY hurt rather
# than merely touched. Below LOKI9_HEAL_HP_FRAC of max, everything behaves as
# LOKI-8; above it, bodies keep walking.
#
# HOW THIS LOSES, and it is the obvious way: chip damage that we now ignore
# accumulates, and a core we would have topped up dies in a long grind. Watch
# for a WIN-rate drop with core-kill share flat -- that is this trade going
# wrong, and it is exactly the shape the "our core is expensive to kill"
# number was describing as a STRENGTH.
# ============================================================================

LOKI9_GARRISON_LESS = True
LOKI9_HEAL_HP_FRAC = 0.80   # heal the core only below this fraction of max HP
