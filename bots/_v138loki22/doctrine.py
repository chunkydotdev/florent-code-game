...
# ============================================================================
# LOKI-22 (2026-08-11) -- THE RUSH IS RE-TESTED ON THE FIXTURE OF RECORD.
# ============================================================================
# THIS FLAG IS FLIPPED BACK ON *TO BE MEASURED*, NOT BECAUSE THE 2026-08-09
# REFUTATION WAS SLOPPY. It was careful, it was replicated, and its author
# predicted the opposite result:
#     orizon  core_kill_share ALL -15.6pp p=0.0201  SHORT -35.4pp p=0.0005
#     cad     core_kill_share ALL -18.9pp p=0.0033  SHORT -22.9pp p=0.0192
#     360 games, paired deterministic, gate CLEARED 12/12.
#
# WHAT CHANGED IS THE INSTRUMENT, NOT THE ARGUMENT. `orizon` and `cad` ARE OUR
# OWN PROBES, and that battery ran 2026-08-09 -- the day BEFORE
# `FIXTURE_OF_RECORD: live_unrated` was set. D12: an arena battery against bots
# we wrote may PRIORITISE a road and may NOT RETIRE one. This is a road retired
# on the retired fixture, and it is the only one of its kind we have found.
#
# THREE INDEPENDENT LINES POINT THE OTHER WAY:
#   1. League census: a forward turret in the ENEMY HALF by ~r20-25 is the
#      strongest fast-kill correlate we have -- rho +0.784 over 71 teams,
#      within-team p<0.0001, +0.685 with rating partialled out, and reverse
#      causality tested (opponent losses by r30 are flat-to-LOWER in fast games,
#      p=0.0005, so it is not a turret following a collapsing enemy).
#   2. `diverge` plants its forward sentinel at r19 and kills us at median r92.
#      We plant at r49. Their opening is IDENTICAL in all four outcome classes
#      -- what varies is OUR side -- and our damage RATE once committed matches
#      theirs (8.91 vs 9.87/round). THE ENTIRE GAP IS WHEN THE CLOCK STARTS.
#   3. The comment above this block, written by us: "We have the mechanism and
#      we under-commit it."
#
# ⛔ AND THE STRONGEST ARGUMENT FOR LEAVING IT OFF, WHICH THE PREREG CARRIES AS
# ITS FALSIFIER: the arena's known bias FLATTERS forward turrets -- ours never
# died there, 0 in 480 games, against 46.9% on the ladder. THE RUSH LOST ANYWAY,
# IN A FIXTURE BIASED TOWARD IT. Nobody has an answer to that. It is a reason to
# size the live leg properly, not a reason to skip it.
LOKI2_RUSH_ON = True       # LOKI-22: re-test on live unrated. Was False.
