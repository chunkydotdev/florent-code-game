...
# LOKI-29B: COUNTERBATTERY ONLY. Re-open the melee path for ENEMY TURRETS and
# nothing else -- no core peck, no siphon hit, no conveyor grind.
# WHY, and it is a number LOKI-QUIET's rationale did not have: that removal
# argued "acting and moving are mutually exclusive and ARRIVAL is scarce", which
# is true. But 25.76% of our builder-rounds are IDLE -- the engine ran run() and
# the bot emitted nothing (99.75% of idle rounds carry a BotOutput, tled 0.00%).
# An idle builder swinging at an adjacent turret costs ZERO movement.
# AND THE TARGET IS THE LARGEST TERM ON THE BOARD: enemy turrets merely EXISTING
# near us is 1.77x / 47.3% of the log hazard gap, and we destroy 0.88x as many
# enemy turrets as the top tier while they build 1.19x more against us.
LOKI29_COUNTERBATTERY_ON = True
