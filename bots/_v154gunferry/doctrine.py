...
# LOKI-32 (s32): v114 SHIPPED WITHOUT FERRY-FIRST. `_v146gunaxis` was branched
# from the PRE-v112 base, so the shipped bot is v112 MINUS ferry-first PLUS
# gunaxis -- and every arm screened overnight (cap6, cap12, bestfit) has the
# same gap. Their measured effects are therefore (X - ferry_first), not X.
# This arm is the first time the two have ever been run TOGETHER.
