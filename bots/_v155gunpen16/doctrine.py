...
# DOSE SWEEP (s32): the shipped value is 8 and NOBODY EVER SWEPT IT -- v114
# went live on a knob at an untested setting. If the currency is MONOTONE in
# this penalty that is direct evidence for the VOLUME reading (a bigger push
# off gunner rays pulls stations further back); an interior optimum would say
# SITING. The discriminator arm answers the same question a second way.
LOKI_GUNAXIS_PENALTY = 16
