...
# launcher 20, and we open with 500.  So the dose is SWEPT rather than guessed,
# two arms bracketing an order of magnitude, exactly as the GUNPEN sweep did.
NON_STRIKE_SURCHARGE = 30
STRIKE_SURCHARGE_MAX_RND = 250   # outer bound only; the live signal is SLOT_RAID_LIVE
