...
# LOKI-38: build a GUNNER instead of a SENTINEL where the line is ALREADY clear.
# Additive: falls through to Sentinel whenever the gunner line is occluded.
LOKI38_GUNADD_ON = True
