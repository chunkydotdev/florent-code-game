...
# LOKI-39: try GUNNER before SENTINEL in _try_counterbattery's choices tuple.
LOKI39_GUN_FIRST = True

# LOKI-40: substitute gunner for sentinel ONLY where the sentinel was affordable.
LOKI40_SUB_ONLY = True
