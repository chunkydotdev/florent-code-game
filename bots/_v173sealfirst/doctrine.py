...
# LOKI-45: hold the approach sentinel until a foothold is live, so the collar
# seals BEFORE the gun opens fire and its damage is not refunded by their heal.
LOKI45_SEAL_FIRST = True
