...
# LOKI-48: cull a builder idle this many consecutive rounds. Swept.
LOKI48_IDLE_CULL = True
IDLE_CULL_RNDS = 12
IDLE_CULL_MIN_RND = 120
IDLE_CULL_FLOOR = 6      # never drop below this many living units (incl. core)
