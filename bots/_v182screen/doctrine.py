...
LOKI_SCREEN_MAX = 2           # approach barriers per raider, whole match
...
LOKI_SCREEN_GAP = 10          # rounds between placements by one raider
LOKI_SCREEN_LOG = True        # replay tag "LOKI44SCR x y rnd" -- dose readout
