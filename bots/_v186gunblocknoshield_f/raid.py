...
class RaidMixin:
    ...
    def _raid_act(self, ct, E, near):
        ...
        # 3b. LOKI-43: BARRIER THE GUNNER'S RAY.  Strictly BELOW the sentinel
        # attempt above -- a round that could plant a sentinel must still plant
        # it -- and below sealing, so the collar is never outbid by cover.
