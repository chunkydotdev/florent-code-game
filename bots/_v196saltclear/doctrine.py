...
LOKI_SALT_ON = True          # master flag: False == the v169 parent, exactly
LOKI_SALT_LOG = True         # print SALT counters into the replay (visibility leg)
...
# --- LOKI-LINKCLEAR: clear an enemy building blocking our own trunk link ---
# _build_next_link had no team check on get_tile_building_id -- an enemy
# barrier planted on our route was read as "already built" and popped off
# the queue, leaving a permanent hole (the L4 defect: nothing re-plans a
# chain once its head is destroyed).  This arm pecks the blocker instead of
# skipping it.
LOKI_LINKCLEAR_ON = True     # clear an ENEMY building blocking our own trunk link
LOKI_LINKCLEAR_TI_FLOOR = 12 # bank floor before spending 2 Ti on a peck
