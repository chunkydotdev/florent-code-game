...
# --- LOKI-LINKROUTE: re-plan the trunk around an enemy building -----------
...
# chain once its head is destroyed).  This arm bans the blocked tile and
# re-plans the chain around it instead of paying to clear it.
LOKI_LINKROUTE_ON = True     # re-plan the trunk around an ENEMY building
