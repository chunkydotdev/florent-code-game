...
# LOKI-FEEDER (QUEUE #45): vs point-blank creepers the turret is a renewable
# resource (measured rebuild latency 1-2 rounds, OPP-lingling40/team-lazy
# profiles 2026-08-13) and the 40 HP builder feeding it is not. When an enemy
# builder bot stands within LOKI_FEEDER_NEAR_DSQ of an enemy turret, our
# turrets shoot the BUILDER above everything except the core.
LOKI_FEEDER_FIRST = True
LOKI_FEEDER_NEAR_DSQ = 8
LOKI_FEEDER_LOG = True     # dose tag FEEDER45; stdout is stripped from
                           # platform replays, so this is local-only by nature
