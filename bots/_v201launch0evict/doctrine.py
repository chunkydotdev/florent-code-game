...
# LOKI-EVICT (#45 iteration 3): 160 -> 0. Iteration 2 proved the eviction
# road cannot open reactively — the sieged economy never reaches the
# launcher price (bank 1-44 vs cost 52-61, gate=eco 100% of refusals) — so
# the launcher must EXIST before the siege. Replication-by-rule of the
# LAUNCH0 screen constant (52.77 +-1.33 at n=5408, prioritising grounds
# only) on the CURRENT incumbent; the exile path is then standing
# feeder-eviction at 0 ammo.
LAUNCHER_MIN_RND = 0
LOKI_EVICT_LOG = True      # dose tag EVICT45; platform strips stdout
