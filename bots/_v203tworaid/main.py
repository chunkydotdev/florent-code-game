...
class Player(EcoMixin, RaidMixin):
    ...
    def _builder(self, ct):
        ...
        # TWORAID (s36, #42 discriminator b): seat 4 converts under the SAME
        # conditions. One body at the ring cannot hold two sentinels against a
        # counter-gunner tempo of ~10 rounds/kill; the one game we put two
        # sentinels up simultaneously is the one game we beat Leviathan's
        # core-tank (autopsy 18f30710: 4 HP/Ti heal beats any single sentinel).
