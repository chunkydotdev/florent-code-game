...
LOKI_STANDOFF_SITING = True  # s36 #41: prefer the FARTHEST legal sentinel site >= MIN_DSQ
LOKI_STANDOFF_MIN_DSQ = 14   # outside their next-door gunner tempo, inside our r^2=32
