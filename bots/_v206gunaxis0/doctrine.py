...
LOKI_GUNAXIS_PENALTY = 0   # QUEUE #33 ABLATION (was 8): shipped in v114 on a
# 92% figure that is stale for the live tree (64.8%); never ablated. 0 makes
# the gun-axis term inert while leaving every other station score untouched.
