...
LOKI_QUIET_ON = False    # QUEUE #48 ABLATION (was True since v102 origin): basis was
# LOKI-5 at 12/15, n=15, short-map, never individually significant, measured blind
# to the parked-raider cost (10.68% of all builder-rounds). Reopens core peck,
# siphon hit and counterbattery wholesale — the doctrine test, vs _v208idlepeck's
# surgical idle-only variant.
