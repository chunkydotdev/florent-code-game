...
# LOKI-IDLEPECK (QUEUE #48): terminal-idle raiders reopen the core peck.
# Surgical alternative to ablating LOKI_QUIET_ON wholesale — quiet stays the
# doctrine for ACTIVE raiders; only a body with a provably empty ladder
# (LOKI_IDLE_PECK_RNDS consecutive actionless rounds) starts spending its
# parked rounds on the core. Basis: research's #48 cut (10.68% of all
# builder-rounds parked, median onset r47) + the 4b039a9c autopsy lever.
LOKI_IDLE_PECK = True
LOKI_IDLE_PECK_RNDS = 8
LOKI_IDLE_PECK_LOG = True   # dose tag IDLEPECK48; platform strips stdout     # no builder melee: no core peck, no siphon hit, no counterbattery
