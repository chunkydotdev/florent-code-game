...
# LOKI-PAVEFIRST (QUEUE #50): pave the belt on the walk to harvester #1 —
# but ONLY toward ore on OUR half (Magnus's conditional: forward ore is a
# claim race, safe ore rewards the belt). Field basis: research's signature
# cut, the top teams pave-first near-universally and we are the outlier.
LOKI_PAVE_FIRST = True
LOKI_PAVE_FIRST_LOG = True   # dose tag PAVE50; platform strips stdout
