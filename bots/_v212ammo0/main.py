...
class Player(EcoMixin, RaidMixin):
    ...
    def _core(self, ct):
        ...
        # LOKI-AMMO0 (mining sweep S2, x3r0_v115:206-211 verbatim): pre-buy
        # one sentinel volley at r0. Ammo starts at 0 with no passive income;
        # our first firing unit is a r13 forward sentinel at 10 ammo/shot.
        # Reverted by v116 and never screened ALONE on any chassis; the
        # family's stacked screens read 51.16-53.31 at n=5408.
        if LOKI_AMMO0_ON and rnd == 0 and ammo < 17:
            amt = min(17 - ammo, ti)
