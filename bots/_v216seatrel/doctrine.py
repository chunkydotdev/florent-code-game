...
# QUEUE #8 — SEAT-RELATIVE SCAN ORDER (ported verbatim from _v151seatrel,
# whose selftest tests/test_seat_relative.py drives both verdicts). The
# coupling-test's DECOUPLED probe: pure geometry, opponent-invariant.
...
def orient_cardinals(core, enemy):
    ...
    ``main.py`` core turn, which runs before any other unit exists.
    """
