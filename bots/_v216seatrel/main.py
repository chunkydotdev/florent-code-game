...
class Player(EcoMixin, RaidMixin):
    ...
    def _core(self, ct):
        ...
        # QUEUE #8 (coupling-test decoupled probe): rotate the shared CARDINALS
        # to start at the cardinal facing the enemy — same code, every seat.
        # Idempotent O(1), called from the Core turn which runs before any
        # other unit exists. Selftest: tests/test_seat_relative.py (11/11
        # maps canonicalise under treatment, 0 under the shipped order).
