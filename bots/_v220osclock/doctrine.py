...
# --- #54 LOKI-OSC: two-tile limit-cycle detector (s38, 2026-08-14) --------
# A moving A<->B loop never trips the stuck>=5 repick (stuck increments only
# when all four moves FAIL) -- census: 11.58% of ALL builder-rounds locked,
# midgard 35.6%. K=8 = four full A-B cycles before firing.
LOKI_OSC_DETECT_ON = True
LOKI_OSC_K = 8
