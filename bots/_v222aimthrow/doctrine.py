...
# --- #51 AIMED THROW (s38): the exile loop is a perfect denial engine that
# converts to ZERO damage (259 throws, 0 HP — decoded). Co-requisite pair,
# one mechanism: throw pads on a friendly Sentinel's firing line + an ammo
# floor of 30 (3 sentinel shots = one builder kill) while a launcher and a
# weapon exist. Flag-off is byte-identical behaviour.
LOKI_AIMEDTHROW_ON = True
