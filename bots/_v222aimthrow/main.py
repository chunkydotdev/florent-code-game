...
class Player(EcoMixin, RaidMixin):
    ...
    def _core(self, ct):
        ...
        if not endgame_dumped:
            ...
            if LOKI_AIMEDTHROW_ON and weapons and ct.read_store(SLOT_LAUNCHER):
                # 3 sentinel shots = one exiled-builder kill; 24 starves at 2.
                ammo_target = max(ammo_target, 30)
