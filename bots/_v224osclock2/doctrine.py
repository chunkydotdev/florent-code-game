...
LOKI_OSC_K = 4              # arm 1b: two full cycles (false fire costs ~1
                            # round; a missed lock costs 8+/cycle repeatedly)
LOKI_OSC_TGT_BAN_RNDS = 80  # the target that produced the loop (raid_ban pattern)
LOKI_OSC_TILE_BAN_RNDS = 40 # the bounce pair itself
