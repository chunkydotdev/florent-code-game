...
SLOT_DEFEND_BEAT = 13
SLOT_THREAT = 14
# --- #3 NESTSHOT (s38): a STANDING enemy turret in the band is committed
# aggression — the counterbattery answers it immediately instead of waiting
# for the core to bleed (Bisons ledger: sentinel removal kills in 2-4 rounds;
# waiting for _core_shelled loses the race; detection + priority were
# ALREADY SHIPPED, this is the last gate).
LOKI_NESTSHOT_ON = True
SLOT_SIEGE = 15
