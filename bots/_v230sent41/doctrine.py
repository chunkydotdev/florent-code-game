...
# --- #41 LOKI-SENTBAND: forward-sentinel siting band + counter-seat denial ---
# vs _v223sealrepair the siting scan accepts any candidate with d^2(target)
# <= 32 and NO minimum (raid.py band check) -- nothing stops a point-blank
# plant inside the reactive counter-gunner's reach (r^2=13, obstacle-blocked).
# Band 14..32 keeps the plant outside gunner range; the 3-Ti barrier on the
# core-side adjacent seat denies the d^2=1 insta-counter-build.  Mechanism
# metric: forward-sentinel median lifetime (baseline 10 rounds) +
# shots-landed-per-sentinel.
LOKI41_BAND_ON = True
LOKI41_MIN_DSQ = 14
LOKI41_BAR_ON = True
LOKI41_BAR_WINDOW = 6       # rounds after the plant we still owe the barrier
