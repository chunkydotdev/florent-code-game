...
# --- #48(b) LOKI-SALTREF: the peck budget refreshes instead of exhausting ---
# vs _v223sealrepair: salt_pecks is a LIFETIME counter against
# LOKI_SALT_CUT_MAX=40 -- bots observed at exactly 40 attacks then permanent
# silence while still holding SLOT_RAID_LIVE (the parked-raider census, #48).
# The refresh forgives the counter every N rounds so cutting pressure is
# sustained.  0 = never (incumbent behaviour), kept as the ablation setting.
LOKI_SALT_CUT_REFRESH_RNDS = 160
