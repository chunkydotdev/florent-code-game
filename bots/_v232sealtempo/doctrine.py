...
# --- #53 LOKI-SEALTEMPO: commit to the ring seal at Juusto's rate (s39) -----
# Head-to-head over 65 archived games (research, BOOK-juusto-2026-08-14 +
# correction): the ring-seal is OUR plank -- 88.6% of our barriers land at
# d^2<=5 of the ENEMY core -- but they execute it at median r32 / 7.0 per
# game against our r51 / 5.0, both rings open at r6.  Not access: commitment
# and rate.  This arm raises the station scorer's pull toward a corner with
# open seats (incumbent literal: 6, which distance swamps within a few
# tiles).  DONE_PUSH unchanged -- one knob per arm.  NON-CAUSAL GUARD
# (research's own): the r32-vs-r51 gap is a measured execution difference on
# a separately ablation-validated asset; nothing here claims the ring is why
# they beat us.  Mechanism metric (live/archive only -- screen replays are
# discarded): median first-seal round + seals-by-r32 per game.
LOKI_SEAL_CORNER_OPEN_PULL = 15   # incumbent behaviour = 6
LOKI_SEAL_CORNER_DONE_PUSH = 12   # unchanged from the incumbent literal
