...
# --- #58 LOKI-EVICT: the forward eviction launcher (s39, 2026-08-14) --------
# Magnus field observation -> identified off throws.tsv: Jython/LingLing40
# base-camp a launcher and evict OUR builders 56-78 times/game (era>=125).
# The MECHANISM is field-proven; THIS APPLICATION -- offensive, beside THEIR
# core, evicting the heal/repair staff inside our kill window -- is
# unmeasured: nobody in the archive does it (research #58 admission).  #47's
# discipline: CONDITIONAL (siege established = live forward sentinel), CAP 1
# (live census + unit latch), Ti floor so it never starves the kill; the
# s37 sweep's -6.34pp priced STANDING launchers and this is neither standing
# nor early by construction.  Metric (live/archive): enemy heal/repair
# actions at d^2<=8 of their core during our siege + ring rebuild latency.
LOKI58_ON = True
LOKI58_TI_FLOOR = 40
LOKI58_NEAR_DSQ = 8
