...
# s44: the launcher cap was a boolean (effectively 1) and never swept. 2 is
# chosen, not measured — prior LAUNCH2/LAUNCH3 arms read 44.67/43.73 on a
# DIFFERENT chassis, which is a reason to measure here, not to skip it.
LOKI_LAUNCHER_CAP = 2
