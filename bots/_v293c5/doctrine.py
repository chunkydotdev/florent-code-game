...
# ---- composed by tools/stack.py from: bodyaware, rnd1, spawnlock, sentshell, catapult
...
LOKI_SPAWNLOCK_TI_FLOOR = 40
LOKI_SPAWNLOCK_NEAR_DSQ = 8
LOKI_SPAWNLOCK_CENSUS_DSQ = 32
