...
# QUEUE.md #33: ablation arm. Row: "one local ablation answers what 5,000
# archived games cannot" — flag shipped v114 on a since-STALE 92% figure
# (shipped tree measures any-gunner 64.8%, any-sentinel 68.4%), and the
# archive can't attribute it (adjacent-version contrast runs backwards).
# Resolution declared in the row: a real effect moves gunner-covered forward
# deaths by >=0.15/game off the 0.60/game baseline; ablate 8 -> 0.
#
