...
# QUEUE.md #53 (re-scoped s40): the floor was swept DOWNWARD only (12->0,
# shipped as SEALFLOOR0 in this v140 incumbent); the UPWARD arm (24) was
# ALLOCATION-CANCELLED, not futility-dropped, so 0 is not proven the
# optimum. Row: "now the cheapest of the three since 0-vs-12 is already
# priced by the ship." This arm samples the untested upward side: 0 -> 24.
#
