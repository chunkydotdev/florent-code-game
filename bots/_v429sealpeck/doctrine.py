...
# ============================================================================
# LOKI-SEALPECK (QUEUE #74, admitted 2026-08-16) -- CORE PECK WHEN THE
# BUILDER HAS NO MOVE TO LOSE.
#
# LOKI_QUIET_ON above silences the core peck because acting and moving are
# mutually exclusive for a builder and ARRIVAL is the scarce quantity --
# pecking a 500 HP Core for 2 damage a round was buying nothing at the price
# of a step.  That premise is an OPPORTUNITY COST, and it is ZERO for a
# builder whose four orthogonal neighbours are all blocked: there is no move
# left for the peck to cost.  Measured: 0 core attacks across 54,429 parked
# builder-rounds; one instance idle 110 rounds beside a 500 HP core (worked
# example e5d311e9 g1, 220 damage forgone, free); and two more from today's
# Bisons loss (stuck r25->r44, in a game lost at r49).  Peck-only per the
# queue row's own text -- it names core peck, siphon hit and counterbattery
# as what LOKI_QUIET_ON silences but only carves out the core peck; it does
# not mention heal, so no heal branch is touched here.
# ============================================================================

LOKI_SEALPECK_ON = True   # QUEUE #74: core peck fires when fully sealed, even under LOKI_QUIET_ON
