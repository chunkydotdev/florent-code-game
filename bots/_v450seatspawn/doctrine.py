...
LOKI_SEATCANON_SPAWN = True  # fix: the spawn-ring sort key hashed ABSOLUTE (x, y), not equivariant under the map's mirror/rotation symmetry, so the two seats opened with unrelated permutations of the same ring (seat effect +6.28pp measured, hash term +4.84pp -- 2026-08-16)
