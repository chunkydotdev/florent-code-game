...
LOKI_BELTBREAK_CAP = 3          # V503: 2->3. ONE MECHANISM WITH THE LINE BELOW (fund what you allow):
                                # BBSTEP measured 132% substitution at CAP=2 (the marginal plant is a
                                # RE-TIMED plant, not an extra one) and R_CAP refusals rising while
                                # plants fell. The cap is the second constraint in the measured nest
                                # TI -> CAP -> siting.
...
LOKI_BELTBREAK_AMMO = 36        # V503: 24->36. Three 12-ammo kill cycles for THREE gunners --
                                # 24 was sized for CAP=2 (one kill cycle per gunner); a third
                                # shredder at 24 gets ~8 ammo = 2 shots < the 3 needed for a
                                # 20-HP belt tile, i.e. a turret nothing funds. Scale with the cap.
