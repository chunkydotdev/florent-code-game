...
# ---------------------------------------------------------------------------
# V504 LOKI-BBAMMO -- the eco x offense pair, minimal form: the carrier
# (BELTBREAK at RND=10, Band 1 twice) plus ONE clause reserving the
# shredder's price from the ammo drip. Flag off == _v488beltbreak2 exactly.
LOKI_BBAMMO_ON = True
# ===========================================================================
