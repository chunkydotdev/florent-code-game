...
class Player(EcoMixin, RaidMixin):
                ...
                if rd_scan:
                    ...
                    if v is not None:
                        ...
                        if hp <= LOKI_RAYDISC_MAX_HP:
                            ...
                            key = (v, -hp, t.x, t.y)
                            if rd_key is None or key > rd_key:
                                rd_best, rd_key = t, key
    ...
    def _rd_log(self, ct, arm, t, n_econ, core_hp, tgt_hp=None):
        ...
        try:
            ...
            p = ct.get_position()
            print("RD507 %s r%d id%d at%d,%d (%d,%d) es=%d chp=%s thp=%s b=%d"
