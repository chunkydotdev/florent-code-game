...
class EcoMixin:
    ...
    def _sync_harvesters(self, ct):
        ...
        # LOKI-SALTRAY: dead write, gated so slot 5 has ONE writer class under
        # the flag.  See the LOKI-SALTRAY doctrine block.
        if live >= ECO_NEED and not SALTRAY_COORD_ON:
            ...
            if (
                ...
                for ddx, ddy in DIR_DELTAS:
                    ...
                    if ok:
                        ...
                        # LOKI-SALTRAY: dead write, gated.  See doctrine.
                        if ct.read_store(SLOT_HARVESTERS) >= ECO_NEED \
                                and not SALTRAY_COORD_ON:
                            ct.write_store(SLOT_ECO_READY, 1)
