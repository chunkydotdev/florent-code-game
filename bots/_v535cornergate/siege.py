...
class SiegeMixin:
    ...
    def _v535_map_refuses(self, ct):
        ...
        The anchor resolution below is `_fs_gate`'s, deliberately duplicated
        rather than shared: same order, same fallbacks, same
        `None -> do not cache, ask again next round` discipline.
        """
