...
# ===========================================================================
SK_HOME_LAUNCHER = False  # ⛔⛔ THE MASTER FLAG, DEFAULT OFF.  ON vs OFF IS the
                          # experiment: with it False this tree is byte-identical
                          # to v610 (identity control, 30/30).  Adoption is a
                          # PHASE-BOUNDARY decision (the ratified structure gates
                          # AMPLIFY on parity, and `_v542wave` ships launchers
                          # while our replication chassis ships none) and is
                          # Magnus's call, not this build's.
...
SK_HL_SEAT_DENSITY = True # site scoring weights each seat by the rounds we have
...
SK_TUBE_FLOOR = False     # ⛔ PLANK 2 -- BUILT, MEASURED, AND SHIPPED OFF.  A
