...
class Player:
    ...
    def _try_counterbattery(self, ct):
        ...
        if threat is None:
            return False
        # Strict form of _plan_siege's economy gate: no home battery at all
        # before the economy stands.  One gun is enough to make `weapons`
        # truthy for the rest of the match, which pins ti_floor at 12 and
        # converts every trickle of income to ammo forever.
