...
class Player:
    ...
    def _try_counterbattery(self, ct):
        ...
        # SLOT_HOME_GUN only: a forward siege turret is offence and must not
        # consume the home battery's free-first allowance (measured on
        # meander -- an r2 siege Sentinel locked every home battery behind
        # >= ECO_NEED harvesters that enemy harassment kept suppressed).
