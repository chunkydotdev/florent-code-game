...
class Player:
    ...
    def _hunt_turret(self, ct):
        ...
        for bid in ct.get_nearby_buildings():
            ...
            # Band sized past Sentinel range (r^2 = 32), measured to the
            # nearest tile of the 2x2 footprint.  Validated twice: the
            # CtrlAltDefeat decode (sentries shelling from dist^2 25-41,
            # outside the old anchor-measured 20) and the v79 jackpot sweep
            # (sentinel at EXACTLY dsq 32 on the diagonal, killed our core
            # with 60 unanswered shots while a builder stood orthogonally
            # adjacent to it -- anchor-measured 50 > 20 kept it out of band).
        ...
        for hp, _d, bid, bp in cands:
            ...
            if healers < self._healer_floor(ct) and hp > HUNT_FINISH_HP:
                continue
