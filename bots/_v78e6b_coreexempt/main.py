...
class Player:
    ...
    def _builder(self, ct):
        ...
        #
        # PIECE K' adds a TRUNK arm beside this Core heal and puts a spend cap
        # on both (see K_HEAL_BUDGET_ON).  Three properties, each measured:
        ...
        if ct.get_action_cooldown() == 0:
            if K_HEAL_BUDGET_ON:
                ...
                # ABLATION coreexempt: Core arm restored to exact Eir 5.1
                # semantics (unbounded under siege, no ledger interaction);
                # trunk arm stays budgeted as-built.  Doubles as the K''
                # candidate shape if this cell measures clean.
