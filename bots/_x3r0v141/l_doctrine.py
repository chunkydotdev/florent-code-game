...
LOKI_TWORAID_ON = True       # s36 #42-b: seat 4 also converts to raid (volume vs core-tanks)
...
LOKI_DIGOUT_ON = False       # v9-FIX discriminator (s37): COMBO suppresses TWORAID
# (2nd sentinel 7/25 vs control 11/25) and the doctrine diff narrows the suspect
# to DIGOUT-or-UNDERECO-code. This arm = combo minus DIGOUT: if the 2nd sentinel
# returns, DIGOUT was the poison; if not, the eco code path is.
