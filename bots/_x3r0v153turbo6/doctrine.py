...
CB_LIVE_TARGET_ON = True
CB_MOBILE_GUNNER_ON = True
CB_BEARING_GATE_ON = True
CB_HUNT_MOVE_ON = True
CB_DRY_MAG_ON = True
...
CB_RANK_THREAT_ON = True
CB_TARGET_BUILDERS_ON = True   # answer enemy builders near the Core, not just turrets
