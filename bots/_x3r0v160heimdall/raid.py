...
class RaidMixin:
    ...
    def _cg_ferry_try(self, ct, E, p, ti, rnd):
        ...
        try:
            ...
            return False
        if ti < cost + self._cg_ferry_floor():
        ...
        self.cg_ferry_n += 1
        self.cg_launch_n += 1        # WAVE 12: the ONE budget, all arms
        self.cg_wait_until = rnd + CAGE_FERRY_WAIT
        try:
            ct.write_store(SLOT_FERRY_ID, ct.get_id() + 1)
