"""v63 OFFLINE — Crush Aug-6 unrated loss maps (+ live CPU wrapper).

v62 plus: expanders step off ore before harvesting (Heart-B mined=0),
Moonrise-B / Meander-A / Eider-Heart-B / Jackpot-B rush bunkers from the
sporks/Pantheon/lazy/Pivot replays, and a larger UNDER ammo magazine.
"""
import math
