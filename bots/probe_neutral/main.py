"""probe_neutral — v1 with every absolute-direction bias removed. EXPERIMENT ONLY.

Exists to discriminate the two candidate causes of the seat-A wipeout maps
(docs/open-questions.md): an engine turn-order advantage vs. our own
absolute-direction habits. If the wipeout vanishes in this bot's mirror match,
the bias was ours; if it survives, it's the engine's. Not a ladder candidate.
