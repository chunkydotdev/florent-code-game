...
| b | "true cpu_max 6–8.4 ms" + the crash/CPU no-lever closure (0/371) | BOOK-0033-2026-08-14 | cpu | **RECHECK post-rebuild.** Owner: research. The closure's direction of risk: if true cpu_max rises with core turns counted, the no-lever verdict only strengthens; a weakening would need cpu_max to have been OVERstated, which this defect cannot produce. Still: recheck, don't argue. |
