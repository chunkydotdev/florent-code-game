...
## COMMISSIONER'S AMENDMENT 3 — 2026-08-21 s52: P3's REFUTATION IS REOPENED — BOTH TESTS MEASURED THE WRONG EFFECT

`AUTOPSY-v174-losses-2026-08-21.md` surprise 1: kladde's copied ring-barrier play IS a weapon — not via spawn denial (refuted here, stands) nor heal denial (refuted here, stands) but via **turret-ammo attrition + belt-throat occupation**: in kladde g5 (yulerune, d4566d49) one 3-Ti barrier tile replanted 119× consumed 236 sentinel shots = 2,360 ammo/Ti (measured two independent ways, agreeing to the unit) against ~357 Ti of their spend — 6.6:1 — while permanently plugging our belt's throat tile. Dose gradient across the match: 100%/80%/63% of our shots in losses, ≤1% in wins. P3's "intel, not a weapon" conclusion is WITHDRAWN; the two specific mechanism refutations it made are RETAINED.
