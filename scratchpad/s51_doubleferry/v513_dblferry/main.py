...
class Player(EcoMixin, RaidMixin, SiegeMixin):
    ...
    def _core(self, ct):
        ...
        if LOKI_FS_CREW and FS_SPAWN_PURPOSE:
            ...
            anchor = None
            if self.n == 0 or (FS_CREW_ON and self.n == FS_CREW_SEAT):
    ...
    def _builder(self, ct):
        ...
        if self.team is None:
            ...
            if n == LOKI_DEFEND_SEAT:
                self.role = "defend"
            elif (LOKI_FS_CREW and FS_CREW_ON and not FS_CREW_CONVERT
                    and n == FS_CREW_SEAT):
