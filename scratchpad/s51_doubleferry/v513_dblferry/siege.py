...
class SiegeMixin:
    ...
    def _fs_gate(self, ct):
        ...
        if max(self.mw, self.mh) < FS_MIN_MAP_DIM:
            ...
            a, b = (self.core.x, self.core.y), (E.x, E.y)
            sig = (self.mw, self.mh, min(a, b), max(a, b))
