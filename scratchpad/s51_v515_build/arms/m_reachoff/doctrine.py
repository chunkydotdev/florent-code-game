...
# --- the one derived DEFAULT this build changes ------------------------------
# ⛔ KEPT AT THE BOTTOM AND DERIVED FROM THE FLAG so that `LOKI_FS_V515 = False`
# restores the parent's shipped value with no other edit.  `main.py:1145` is
# the single runtime reader; nothing in doctrine derives from it at import.
if LOKI_FS_V515 and FS_V515_DOOR_OFF:
    FS_HOME_TURRET_RESPONSE = False
...
# --- ARM OVERRIDE: m_reachoff (src bots/_v515ecosalt) ---
FS_V515_REACH = False
FS_V515_REACH_PROBE = True
FS_REACH_LOG = True
