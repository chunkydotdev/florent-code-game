...
class Player(EcoMixin, RaidMixin, SiegeMixin):
    ...
    def _core(self, ct):
        ...
        if not endgame_dumped:
            ...
            print("MAGTRACE", rnd, "ti", ti, "ammo", ammo, "floor", ti_floor,
                  "target", ammo_target, "chunk", chunk, "ph", fs_ph,
                  "fslive", int(fs_live), "under", int(bool(under)),
                  "wtop", weapons_top, "fwd", fwd_guns, "harv", harv,
                  file=sys.stderr)
