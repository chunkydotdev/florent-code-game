    ...
    def _v519_gunfirst(self, ct, E, p, rnd):
        ...
        try:
            planted = self._try_beltbreak_gunner(
                ct, E, rnd_floor=FS_V519_GF_MIN_RND)
        except Exception as _e:
            print("GF519 EXC", rnd, repr(_e), file=sys.stderr)
            return False
        print("GF519 TRY", rnd, "planted", 1 if planted else 0,
              "refuse", dict(self.bb_refuse), file=sys.stderr)
        if not planted:
            return False
