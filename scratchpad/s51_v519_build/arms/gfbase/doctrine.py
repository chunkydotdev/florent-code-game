...
FS_V519_GF_MAX_PLANTS = 1   # per BODY, per match.  The live census in
                            ...
                            # arriving.
FS_V519_GF_TI_FLOOR = 30    # ⭐ THE BUDGET GUARD, and its value is MEASURED,
                            ...
                            # paid.  See the build report for the table.
...
# --- ARM OVERRIDE: gfbase (src bots/_v519cripple) ---
FS_V519_GUNFIRST = False
FS_V519_MODESWITCH = False
FS_V519_GF_LOG = True
