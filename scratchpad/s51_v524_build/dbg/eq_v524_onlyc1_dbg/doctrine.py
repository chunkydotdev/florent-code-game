...
FS_V519_MODE_LOG = True    # MODE519: one stderr line the first time the mode
...
FS_V522_FLOOR = True        # the mechanism.  ⭐ v524 CHANGE 2 -- flipped True
...
FS_V524_LOG = True          # V524: one stderr line the first time the exact
