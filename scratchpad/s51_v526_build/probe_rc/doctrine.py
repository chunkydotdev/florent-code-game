...
# --- s51 v526 ROOT-CAUSE PROBE INSTRUMENT (scratch tree only, never shipped) ---
V526RC = True
V526RC_MAXRND = 60          # TEMPO/spawn tape horizon
V526RC_WALK = True          # WALK tape: every nav call, all rounds
