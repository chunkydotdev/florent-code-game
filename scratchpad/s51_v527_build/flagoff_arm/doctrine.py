...
LOKI_FS_V527 = False        # master.  False == the RDV-only parent unchanged.
                            # THE KNOWN-ZERO ARM: this file is v527 with the
                            # master off, and it must play the RDV-only parent
                            # byte for byte.
