#!/usr/bin/env python3
"""v534 build instrument #7 -- GAME-LEVEL ROW IDENTITY across arms.

Reads a `remote_battery.py` tape and compares arms cell-by-cell on the SAME
...
# ⭐ v535 ADDITION.  The v534 form asked "are these two arms identical?" over a
...
# the boards it REFUSES.  A whole-tape count cannot express that, and a
...
# build's `gatemap.py` verdict for the two boards in the map set, quoted here
