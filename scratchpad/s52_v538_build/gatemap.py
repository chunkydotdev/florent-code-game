...
def table(tree="_v538refine", partree="_v537socket"):
    mods = load_tree(tree)
...
def selftest():
    ...
    off = _flagged_tree("_v538refine", FS_V538_CLAIM_GATE=False)
    ...
    coff = _flagged_tree("_v538refine", FS_V537_SOCKET=False)
