...
export PAR=4
export OUT=scratchpad/s52_v538_build/mech2
export OPP=$PWD/bots/_x3r0v169mjolnir
export ARMS="v536trust=bots/_v536trustport,v537socket=bots/_v537socket,v538refine=bots/_v538refine"
export MAPS=archipelago,yulerune,glacierkeep
echo "MECH2 START $(date -u +%Y-%m-%dT%H:%M:%SZ)"
for i in 1 2 3 4 5 6; do
  ...
  echo "  MECH2 BLOCK $i (seeds $a-$b) done $(date -u +%H:%M:%SZ)"
done
echo "MECH2 DONE $(date -u +%Y-%m-%dT%H:%M:%SZ)"
