...
REP = os.path.join(SCR, "replays")
os.makedirs(REP, exist_ok=True)

ARM = os.path.join(SCR, "arm")
OPP = os.path.join(REPO, "bots/_v488beltbreak2")
JOBS = [("glacierkeep", 5), ("glacierkeep", 7), ("nordkap", 1),
        ("nordkap", 3), ("atoll", 2), ("glacierkeep", 0)]
...
if __name__ == "__main__":
    with open(os.path.join(SCR, "batch.tsv"), "w") as fh:
