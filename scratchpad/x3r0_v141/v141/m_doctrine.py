...
# that never comes whole â‰ˆ 25 Ti of heals on a 3-20 Ti building -- past its
...
LOKI_SEAL_TI_FLOOR = 6     # keep a peck's worth of change in the bank
...
LOKI_FWD_MIN_HARV = 1       # do not open the siege before the economy exists
...
#      once, LOKI_ECO_SEATS = (1, 2) are the economy (seat 3 joins the
...
LOKI_SALT_TI_FLOOR = 6       # bank floor for a salt barrier (matches LOKI_SEAL_TI_FLOOR)
LOKI_SALT_MAX_PER_UNIT = 8   # total barriers one raider may salt in its life
