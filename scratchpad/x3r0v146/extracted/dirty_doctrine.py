...
LOKI_MAX_BUILDERS = 14      # hard lifetime ceiling on spawns
LOKI_SURPLUS_TI = 180       # bank above which extra bodies are bought
LOKI_SURPLUS_EXTRA = 3      # extra seats bought by a surplus bank
LOKI_RICH_TI = 450          # bank above which we buy the rest
LOKI_RICH_EXTRA = 3
LOKI_SPAWN_RESERVE = 40     # never spend the last 60 Ti on a body
...
LOKI_SEAL_TI_FLOOR = 8     # keep a peck's worth of change in the bank
...
LOKI_FWD_TI_FLOOR = 25      # bank left after paying for one
...
LOKI_SALT_MAX_PER_UNIT = 6   # total barriers one raider may salt in its life
...
LOKI_SALT_CUT_MAX = 60       # per-unit peck budget on enemy belt (2 Ti each)
