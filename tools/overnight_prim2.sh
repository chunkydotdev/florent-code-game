...
# (identical function, same fix applied to this pool26 variant).
check_cancel() {
...
n=$existing
seed=$(( SEEDLO + n / 4 ))   # 2 maps x 2 seats per cycle (prim2 variant — divisor MUST equal 2*len(MAPS))
